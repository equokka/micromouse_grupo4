...
bool check_collision(int direction, int **maze, int *pos)
{
  switch (direction)
  {
  case 0: return (bool) maze[(pos[1] + 1) - 1][(pos[0]    ) - 1] != 1; break;
  case 1: return (bool) maze[(pos[1]    ) - 1][(pos[0] + 1) - 1] != 1; break;
  case 2: return (bool) maze[(pos[1] - 1) - 1][(pos[0]    ) - 1] != 1; break;
  case 3: return (bool) maze[(pos[1]    ) - 1][(pos[0] - 1) - 1] != 1; break;
  }
}
